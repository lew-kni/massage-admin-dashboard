        ...
        <div class="card-body space-y-5">
          ...
          <div class="border-t pt-5 dark:border-gray-700">
            ...
            <p class="text-xs text-amber-600 mt-1" v-if="form.overrideEnabled">
              <i class="fas fa-triangle-exclamation mr-1"></i>Every outgoing email
              will be sent to this address instead of the real recipient. The
              intended recipient is still recorded in history.
            </p>
          </div>
          ...
          <div class="border-t pt-5 dark:border-gray-700 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                type="email"
                class="input-field"
                placeholder="Where you receive notifications"
              />
              <p class="text-xs text-gray-400 mt-1">
                New enquiries, booking requests and pre-visit form completions are
                sent here. Defaults to the sending mailbox if left blank.
              </p>
            </div>
          </div>
        </div>
